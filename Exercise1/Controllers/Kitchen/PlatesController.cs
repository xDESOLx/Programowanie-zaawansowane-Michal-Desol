...
namespace Exercise1.Controllers.Kitchen
{
    public class PlatesController : Controller
    {
        ...
        public PlatesController(Exercise1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Plates != null ? 
                          ...
                          Problem("Entity set 'Exercise1Context.Plate'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Exercise1Context.Plate'  is null.");
            }
            var plate = await _context.Plates.FindAsync(id);
            if (plate != null)
            {
