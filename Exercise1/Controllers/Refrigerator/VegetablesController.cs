...
namespace Exercise1.Controllers.Refrigerator
{
    public class VegetablesController : Controller
    {
        ...
        public VegetablesController(Exercise1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Vegetables != null ? 
                          ...
                          Problem("Entity set 'Exercise1Context.Vegetable'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Exercise1Context.Vegetable'  is null.");
            }
            var vegetable = await _context.Vegetables.FindAsync(id);
            if (vegetable != null)
            {
