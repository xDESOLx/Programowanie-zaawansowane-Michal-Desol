...
namespace Exercise1.Controllers.Refrigerator
{
    public class MeatsController : Controller
    {
        ...
        public MeatsController(Exercise1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Meat != null ? 
                          ...
                          Problem("Entity set 'Exercise1Context.Meat'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Exercise1Context.Meat'  is null.");
            }
            var meat = await _context.Meat.FindAsync(id);
            if (meat != null)
            {
