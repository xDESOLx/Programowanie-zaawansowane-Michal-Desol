...
namespace Exercise1.Controllers.Library
{
    public class BooksController : Controller
    {
        private readonly Exercise1Context _context;

        public BooksController(Exercise1Context context)
        {
            _context = context;
        }
        ...
        {
            var exercise1Context = _context.Books.Include(b => b.Author).Include(b => b.Genre);
            return View(await exercise1Context.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Exercise1Context.Book'  is null.");
            }
            var book = await _context.Books.FindAsync(id);
            if (book != null)
            {
