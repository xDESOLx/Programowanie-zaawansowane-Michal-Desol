...
namespace Exercise2.Controllers.Kitchen
{
    public class GlassesController : Controller
    {
        ...
        public GlassesController(Exercise2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Glasses != null ? 
                          ...
                          Problem("Entity set 'Exercise2Context.Glass'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Exercise2Context.Glass'  is null.");
            }
            var glass = await _context.Glasses.FindAsync(id);
            if (glass != null)
            {
