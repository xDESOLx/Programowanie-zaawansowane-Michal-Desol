...
namespace Exercise2.Controllers.Kitchen
{
    public class KnivesController : Controller
    {
        ...
        public KnivesController(Exercise2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Knives != null ? 
                          ...
                          Problem("Entity set 'Exercise2Context.Knife'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Exercise2Context.Knife'  is null.");
            }
            var knife = await _context.Knives.FindAsync(id);
            if (knife != null)
            {
