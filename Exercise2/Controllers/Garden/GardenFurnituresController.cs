...
namespace Exercise2.Controllers.Garden
{
    public class GardenFurnituresController : Controller
    {
        private readonly Exercise2Context _context;

        public GardenFurnituresController(Exercise2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.GardenFurniture != null ? 
                          ...
                          Problem("Entity set 'Exercise2Context.GardenFurniture'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Exercise2Context.GardenFurniture'  is null.");
            }
            var gardenFurniture = await _context.GardenFurniture.FindAsync(id);
            if (gardenFurniture != null)
            {
