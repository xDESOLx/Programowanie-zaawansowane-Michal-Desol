...
namespace Exercise2.Controllers.Garden
{
    public class ToolsController : Controller
    {
        ...
        public ToolsController(Exercise2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Tools != null ? 
                          ...
                          Problem("Entity set 'Exercise2Context.Tool'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Exercise2Context.Tool'  is null.");
            }
            var tool = await _context.Tools.FindAsync(id);
            if (tool != null)
            {
