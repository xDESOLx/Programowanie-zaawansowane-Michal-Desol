...
namespace Exercise2.Controllers.Garden
{
    public class TreesController : Controller
    {
        ...
        public TreesController(Exercise2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Trees != null ? 
                          ...
                          Problem("Entity set 'Exercise2Context.Tree'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Exercise2Context.Tree'  is null.");
            }
            var tree = await _context.Trees.FindAsync(id);
            if (tree != null)
            {
