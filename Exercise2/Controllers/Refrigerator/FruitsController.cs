...
namespace Exercise2.Controllers.Refrigerator
{
    public class FruitsController : Controller
    {
        ...
        public FruitsController(Exercise2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Fruits != null ? 
                          ...
                          Problem("Entity set 'Exercise2Context.Fruit'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Exercise2Context.Fruit'  is null.");
            }
            var fruit = await _context.Fruits.FindAsync(id);
            if (fruit != null)
            {
